...
To help you to get going, there are two different mocking alternatives already included in the 
starting code. You can hand-code your own mock by building on "MockMemoryDevice.cpp", or you can 
use GMock by using "GMockMemoryDevice". There is a test case using each in "DeviceDriverTest.cpp". 
Choose the one you prefer, and delete the other one.
